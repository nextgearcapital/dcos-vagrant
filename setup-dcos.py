...
if __name__ == "__main__":
    ...
    if arguments["destroy"] == True:
        ...
        try:
            ...
            log.error("Looks like I can't use the vagrant command. Check your path, Jim.")
        ...
        if arguments["--force"] == True:
            ...
            try:
                ...
                log.error("More than likely a file was added while trying to remove the directory tree or there are read-only files in there.")
    ...
    if arguments["deploy"] == True:
        ...
        try:
            ...
            if os.path.exists(builddir):
                log.error("The directory already exists, Jim! Remove it or rename it before running this script again.")
        ...
        log.info("Downloading the dcos_generate_config.sh script to the root of the repo.\n")
        try:
        ...
        try:
            ...
            log.error("Doesn't look like I can get to VBoxManage, Jim. Might wanna check your path.")
        ...
        print("\n")
        log.info("We need to export an environment variable to set the config version.")
        ...
        try:
            ...
            log.error("Couldn't copy \"VagrantConfig.yaml.example\" to \"VagrantConfig.yaml\"")
        ...
        if arguments["[--dev]"] == True:
            ...
            try:
                ...
                log.error("Looks like I can't use the npm command. Check your path, Jim.")
